...
*Une fois la base de données interrogée et la concordance établie entre le nom et le mot de passe reçus, la base de données envoie les informations de l'utilisateur vers le client en repassant par l'intermédiaire du serveur : c'est la variable " donneesUtilisateur ".*  
...
**> Consigne**  
En se basant sur le code existant et se servant de la méthode **calculerAge**, modifier la variable **donneesUtilisateur** pour qu'elle réponde à ces deux exigences.
